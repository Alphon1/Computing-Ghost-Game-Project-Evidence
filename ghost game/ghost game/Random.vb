...
Public Class Random
    ...
    Dim power As New Bitmap(My.Resources.crown, 35, 35)
    ...
    Dim levelstring As String = My.Computer.FileSystem.ReadAllText(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\Computing\Year 12\Project\Random.txt")
        ...
        For X As Integer = 0 To 26
            ...
            For Y As Integer = 1 To 16
                ...
                Select Case column(Y - 1)
                    ...
                    Case Is = "u"
                        display(box_index).BackgroundImage = power
                        display(box_index).Tag = "power"
                    Case Else
                        display(box_index).Tag = Nothing
                End Select
            Next
    ...
    Private Sub Slower_Tick(sender As Object, e As EventArgs) Handles Slower.Tick
        Equipped_item.Text = Main.equipped
        If victory.Visible = False And gameover.Visible = False Then
